...
public final class Utility {
    ...
    public final static String PHONE_FORMAT = "000-000-0000";

    public final static String USER_NAME = "Name cannot be empty";

    public final static String EMPTY_FIELD = "Empty field";
